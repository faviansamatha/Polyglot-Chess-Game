...
;(function () {
  ...
  var DEFAULT_DRAG_THROTTLE_RATE = 10
  var ELLIPSIS = '…'
  ...
  var DEFAULT_APPEAR_SPEED = 10
  var DEFAULT_MOVE_SPEED = 10
  var DEFAULT_SNAPBACK_SPEED = 10
  var DEFAULT_SNAP_SPEED = 10
  var DEFAULT_TRASH_SPEED = 10
  ...
  function expandConfig (config) {
    ...
    if (!config.hasOwnProperty('pieceTheme') ||
      ...
      config.pieceTheme = '/static/chessboardLibrary/img/chesspieces/wikipedia/{piece}.png'
    }
